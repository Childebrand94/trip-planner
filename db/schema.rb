...
ActiveRecord::Schema[7.1].define(version: 2024_02_29_195719) do
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["debtor_id"], name: "index_payments_on_debtor_id"
    t.index ["expense_id"], name: "index_payments_on_expense_id"
    t.index ["states_id"], name: "index_payments_on_states_id"
  end
  ...
  add_foreign_key "payments", "debtors"
  add_foreign_key "payments", "expenses"
  add_foreign_key "payments", "states", column: "states_id"
